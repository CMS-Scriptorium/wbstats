 ...
 *
 * 0.2.6.0
 * - Reorganisize files (classes and tabs)
 * - Namespace for classes
 * - New class "Config" to get rid of the some ugend var-declarations
 * - Update some values (min. WB Version, PHP version, etc.)
 *
 * 0.2.5.9
